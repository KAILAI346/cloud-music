      ...
      <el-container>
        ...
        <el-aside :width="isToggle ? '64px' : '130px'" v-show="isMenu">
            <div class="toggle" @click="toggleClick">
                <div class="is-toggle" v-show="!isToggle">
                  <i class="el-icon-arrow-left"></i>
                  <i class="el-icon-arrow-left"></i>
                  <i class="el-icon-arrow-left"></i>
                </div>
                <div class="no-toggle" v-show="isToggle">
        ...
        <el-main>
          <router-view/>
          <div class="menu-cover" @click="showMenu" v-show="isMenu"></div>
        </el-main>
      </el-container>
      <!-- 底部 -->
...
<script>
import HomeHeader from './childCom/HomeHeader.vue'
import Aplayer from '../aplayer/Aplayer.vue'
